...
public class RegisterJson {
    ...
    public RegisterJson(String loginname, String password, int regiontype, String nickname, String licensecreditno, String shopname, String address, String industry, String licensepic) {
